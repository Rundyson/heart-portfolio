    ...
    <section className="container">
      ...
      <div className="awards-grid">
        <div className="award-card">
          <img src="/public/img/3rdH.png" alt="Certificate" />
        ...
        <div className="award-card">
          <img src="/public/img/cmsc.jpg" alt="Certificate" />
          <div className="award-content">
        ...
        <div className="award-card">
          <img src="/public/img/pinoy.png" alt="Certificate" />
          <div className="award-content">
        ...
        <div className="award-card">
          <img src="/public/img/pinoy2.png" alt="Certificate" />
          <div className="award-content">
            <h3>PINOY MEDIA CONGRESS 2025 (PHILIPPINE ASSOSCIATION FOR COMMUNICATION EDUCATORS)</h3>
            <span>2025</span>
          </div>
